...
// 2).slice = Returns a part of the original string as a new string. 
...
// 11 - 6 = 5(here assumed that passed 5 index so its slice "ILove" and return Nodejs)
