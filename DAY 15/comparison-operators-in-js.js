...
console.log(5=='5'); 
// output = true
// here its not compare the variable datatypes(number and string) its only compare the value of the variable
...
// here if we compare with == its return output = true (because its compare the variable value not compare variable datatypes)
